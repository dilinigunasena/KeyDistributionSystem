...
<body>
	<header>
		...
		<nav id="navfix" class="navbar navbar-inverse" role="navigation">
			<a class="navbar-brand" href="index.php"><img class="img img-responsive" src="favicon.png" /> Key Distribution System</a>
              ...
              <?php if($logged == 1) { ?>
		      	<li class="dropdown">
		      		...
		      		<ul class="dropdown-menu">
			            <li><a href="dashboard.php">Account Settings <span class="fa fa-cogs pull-right"></span></a></li>
          			</ul>
		      	</li>
                <?php } else if($logged == 0) { ?>
		        <ul class="dropdown-menu">
			            <li><a href="index.php?logout=1" class="text-muted"> Register <span class="fa fa-keys pull-right"></span></a></li>
          			</ul>
		        <?php } ?>
		      </ul>
		    </div><!-- /.navbar-collapse -->
